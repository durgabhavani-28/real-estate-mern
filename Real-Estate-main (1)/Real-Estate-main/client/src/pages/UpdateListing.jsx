  ...
  return (
    ...
    <div className=' flex gap-7 flex-wrap mt-4'>
      ...
      <div className=' flex flex-wrap gap-6'>
        ...
        <button disabled={loading||uploading} className='border-none uppercase font-normal disabled:opacity-70 rounded-lg hover:opacity-95 p-3 text-white' style={{backgroundColor:'#302825'}}>{loading ? 'Updating.....':'Update Listing'}</button>

            ...
            <form onSubmit={handleSubmit} className='flex flex-col gap-8 '>
                ...
                <div className='flex gap-2 flex-wrap'>
                    ...
                    <div className='flex gap-2 items-center'>
                        <input type="checkbox" id='all' className='w-5 bg-gray-200' onChange={handleChange} checked={sidebardata.type==='all'}/>
                        <span className='whitespace-nowrap'>Rent and Sale</span>
                    </div>
                    <div className='flex gap-2 items-center'>
                        <input type="checkbox" id='rent' className='w-5 bg-gray-200' onChange={handleChange} checked={sidebardata.type==='rent'}/>
                        <span>Rent</span>
                    </div>
                    <div className='flex gap-2 items-center'>
                        <input type="checkbox" id='sale' className='w-5 bg-gray-200' onChange={handleChange} checked={sidebardata.type==='sale'}/>
                        <span>Sale</span>
                    </div>
                    <div className='flex gap-2 items-center'>
                        <input type="checkbox" id='offer' className='w-5 bg-gray-200' onChange={handleChange} checked={sidebardata.offer}/>
                        <span>Offer</span>
                    </div>
                </div>
                <div className='flex gap-2'>
                    ...
                    <div className='flex gap-2 items-center'>
                        <input type="checkbox" id='furnished' className='w-5 bg-gray-200' onChange={handleChange} checked={sidebardata.furnished}/>
                        <span>Furnished</span>
                    </div>
                </div>
                <div className='flex items-center gap-2'>
                    ...
                    <select id="sort_order" onChange={handleChange} defaultValue={'created_at_desc'} className='border rounded-lg p-3'>
                        <option value={'regularPrice_desc'}>Highest First</option>
                        <option value={'regularPrice_asc'}>Lowest First</option>
